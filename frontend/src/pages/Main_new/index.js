    ...
    return (
		<div className={classes.box}>
            ...
            <ModalWindow
                ...
                description="Вы действительно хотите удалить мультипаки(и)?"
            >
                <Button onClick={() => {
                    axios.delete(address + "/api/v1_0/remove_multipacks_to_refresh_wrapper")
                        .then(() => {
                            setReturnNotificationText(notificationText)
                            setNotificationText("Мультипаки успешно удалены")
            ...
            {modalError && (
                ...
                >
                    {{modalError}}
                    <Button onClick={() => setModalError("")}>Сбросить ошибку</Button>
                </ModalWindow>
            )}
			<header className={classes.header}>
                ...
                <div className={classes.header__info}>
                    ...
                    <HeaderInfo title="Куб:" amount={batchSettings.multipacks} suffix="мультипаков" />
                    <HeaderInfo title="Мультипак:" amount={batchSettings.packs} suffix="пачки" />
                    <HeaderInfo title="Пинцет:" amount={batchSettings.multipacksAfterPintset} suffix="мультипаков" />
                </div>
                    ...
                    <ul className={classes.variants__list}>
                        ...
                        <li className={classes.variants__item}
                            ...
                            <label htmlFor="variants-2" className={[classes.variants__itemLabel, bigViewMode === bigViewModes.pallet && 'active'].join(' ')}>
                                <h3 className={classes.variants__itemTitle}>Мультипаки</h3>
