...
const bathesParamsTableProps = [
    ...
    {name: "packs", title: "Пачек в мультипаке"},
    {name: "multipacks", title: "Мультипаков в кубе"},
    {name: "multipacks_after_pintset", title: "Мультипаков после пинцета"},
]
        ...
        <>
            <div style={{padding: 20}}>
                ...
                >
                    <div>
                        <TextField
                                placeholder="Пачек в мультипаке"
                                onChange={async e => {
                        ...
                        />
                        <TextField
                                placeholder="Мультипаков в кубе"
                                onChange={async e => {
                        ...
                        />
                        <TextField
                                placeholder="Мультипаков после пинцета"
                                onChange={async e => {
