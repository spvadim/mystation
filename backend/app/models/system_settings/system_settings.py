...
class SystemSettings(Model):
    ...
    owen_settings: OwenSettings = OwenSettings()
    signal_settings: SignalSettings = SignalSettings()
...
class SystemSettingsPatchScheme(BaseModel):
    ...
    owen_settings: Optional[OwenSettings]
    signal_settings: Optional[SignalSettings]
